          ...
          <h2 class="header-title">Add New Slide</h2>
            ...
            {!! Form::open(['files' => 'true']) !!}
              ...
              <div class="form-group">
                ...
                <input type="text" name="descripe" class="form-control" autocomplete="off" value="{{$data->description}}" >
              </div>
              
              <div class="form-group">
                <label>Sort: </label>
                <input type="number" name="sort" class="form-control" autocomplete="off" placeholder="default: 0" value="{{$data->sort}}" >
              </div>
